...
type UserServiceClient interface {
	...
	Search(ctx context.Context, in *SearchUserRequest, opts ...grpc.CallOption) (*PaginatedUserResponse, error)
	Delete(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*DeleteUserResponse, error)
}
...
func (c *userServiceClient) Search(ctx context.Context, in *SearchUserRequest, opts ...grpc.CallOption) (*PaginatedUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userServiceClient) Delete(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*DeleteUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	Search(context.Context, *SearchUserRequest) (*PaginatedUserResponse, error)
	Delete(context.Context, *IdRequest) (*DeleteUserResponse, error)
...
func (UnimplementedUserServiceServer) Search(context.Context, *SearchUserRequest) (*PaginatedUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Search not implemented")
}
func (UnimplementedUserServiceServer) Delete(context.Context, *IdRequest) (*DeleteUserResponse, error) {
